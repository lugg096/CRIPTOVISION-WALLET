    ...
    InicioPageModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                inicio_routing_module_1.InicioPageRoutingModule
            ],
            declarations: [inicio_page_1.InicioPage]
        })
    ], InicioPageModule);
    return InicioPageModule;
}());
exports.InicioPageModule = InicioPageModule;
