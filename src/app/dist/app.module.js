...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [app_component_1.AppComponent, recibir_component_1.RecibirComponent, transactions_component_1.TransactionsComponent, generar_code_qr_component_1.GenerarCodeQRComponent],
            entryComponents: [recibir_component_1.RecibirComponent, transactions_component_1.TransactionsComponent, generar_code_qr_component_1.GenerarCodeQRComponent],
            imports: [
                forms_1.FormsModule,
